async function fetchAnswer() {
  try {
    let KEY = "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"; // replace with your API key
    ...
    for (let i = 0; i < arry.length; i++) {
      answersText += " " + arry[i].innerText;
    }
    chatMsg = `${directions} ${question} answer choices(choose only the letter associated with the answer and please keep it to one line): ${answersText}`;
